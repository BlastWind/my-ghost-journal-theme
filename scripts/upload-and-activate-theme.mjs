...
const data = { file: `dist/${process.env.npm_package_name}.zip` }; // npm exports package.json fields as npm_package_<field_name>, so this accesses the name field in package.json
